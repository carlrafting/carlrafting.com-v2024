...
If this sounds like something that you could make use of, "head on over to the project's home page":/autogrow/, and when you're done reading, "download the source code from Github":https://github.com/carlrafting/autogrow.
